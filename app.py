...
# ── Set token immediately at startup ─────────────────────────
...
with tab2:
    ...
    if st.button("Generate Race Story", type="primary"):
        ...
        with col1:
            ...
            st.markdown("<div style='text-align:center; font-weight:600; color:#1a1a1a;'>Charles Leclerc</div>", unsafe_allow_html=True)
        ...
        with col2:
            ...
            st.markdown("<div style='text-align:center; font-weight:600; color:#1a1a1a;'>Carlos Sainz</div>", unsafe_allow_html=True)
            st.markdown("<div style='text-align:center; font-size:0.8em; color:#e10600;'>Ferrari</div>", unsafe_allow_html=True)
        ...
        with col3:
            ...
            st.markdown("<div style='text-align:center; font-weight:600; color:#1a1a1a;'>Oscar Piastri</div>", unsafe_allow_html=True)
